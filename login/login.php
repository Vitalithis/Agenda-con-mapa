...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
    $usuario = mysqli_real_escape_string($conexion, $_POST['reg_usuario']);
    ...
    if (mysqli_stmt_num_rows($stmt_check) > 0) {
        ...
        $sql_insert = "INSERT INTO users (usuario, password, role, img) VALUES (?, ?, ?, 'user', ?)";
        $stmt_insert = mysqli_prepare($conexion, $sql_insert);

        if ($stmt_insert) {
            $hashed_password = password_hash($password, PASSWORD_DEFAULT);
            mysqli_stmt_bind_param($stmt_insert, 'ssss', $usuario, $hashed_password, $default_img);
                ...
                <div class="card text-center">
                    ...
                    <form method="POST" class="mt-4">
                        <div class="mb-3">
                            ...
                            <input type="usuario" class="form-control" id="usuario" placeholder="ejemplo@ejemplo.cl" name="usuario" required>
                        </div>
                        <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="card text-center">
                    ...
                    <form method="POST" class="mt-4">
                        ...
                        <div class="mb-3">
                            <label for="usuario" class="form-label">Correo Electrónico</label>
                            <input type="usuario" class="form-control" id="usuario" placeholder="ejemplo@ejemplo.cl" name="reg_usuario" required>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Contraseña</label>
